...
def get_stock_list(x_position, df=-4, kline_type=StockConfig.kline_type_week):
...
if __name__ == '__main__':
    ...
    date = 'yyyy-mm-dd'
    stock_list = get_stock_list(x_position=-1, df=-4, kline_type=StockConfig.kline_type_day)
